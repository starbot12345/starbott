    ...
    if (user.presence.game.name === 'Spotify' && user.presence.game.type === 2) {
        try {
            ...
            const embed = new Discord.RichEmbed()
                ...
                .setFooter(`STAR BOT Spotify Sistemi ${message.author.username} tarafından istendi.`, "https://cdn.discordapp.com/emojis/515260605347659777.png?v=1")
                .setDescription(`
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['spo', 'spoti', 'soti', 'spotif', 'spotify'],
  permLevel: 0
};
